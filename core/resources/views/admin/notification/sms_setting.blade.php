...
<div class="row mt-4 d-none configForm" id="infobip">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Base Url')" name="infobip_baseurl" value="{{ @$smsConfig->infobip->baseurl }}" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('Api Key') </label>
                                    <input type="text" class="form-control" placeholder="@lang('Api Key')" name="infobip_apikey" value="{{ @$smsConfig->infobip->apikey }}" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('From Number') </label>
                                    <input type="text" class="form-control" placeholder="@lang('From Number')" name="infobip_from" value="{{ @$smsConfig->infobip->from }}" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('From Number')"
                                        name="from" value="{{ @$smsConfig->twilio->from }}">
                                </div>
                            </div>
                        </div>
